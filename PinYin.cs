...
namespace RX
{
    public static class PinYin
    {
        ...
        public static string ToPinyin(this string chs, string separator, bool initialCap)
        {
        ...
        /// <param name="separator">连接拼音之间的分隔符</param>
        /// <returns>包含中文字符串的拼音的字符串</returns>
        public static string ToPinyin(this string chs, string separator)
        {
            return ToPinyin(chs, separator, false);
        }
        ...
        /// <param name="initialCap">指定是否将首字母大写</param>
        /// <returns>包含中文字符串的拼音的字符串</returns>
        public static string ToPinyin(this string chs, bool initialCap)
        {
            return ToPinyin(chs, "", initialCap);
        }
        ...
        /// <param name="chs">要转换的中文字符串</param>
        /// <returns>包含中文字符串的拼音的字符串</returns>
        public static string ToPinyin(this string chs)
        {
            return ToPinyin(chs, "");
        }
        ...
        /// <returns>返回值</returns>
        public static string GetFirstPY(this string chsStr)
        {
